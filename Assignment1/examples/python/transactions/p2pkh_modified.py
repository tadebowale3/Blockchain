...
sys.path.append(os.path.dirname(filePath + "../lib."))
...
bob_rpc = RpcSocket({ 'wallet': 'TestnetWallet2'})
assert bob_rpc.check()

## Get a utxo for Alice.
alice_utxo = rpc.get_utxo(2)
...
fee = 200
bob_recv_value = 200
alice_change_value = alice_utxo['value'] - bob_recv_value - fee
